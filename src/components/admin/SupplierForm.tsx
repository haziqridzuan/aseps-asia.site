  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          <label htmlFor="onTimeDelivery" className="text-sm font-medium">
            On-Time Delivery (%)
          </label>
          <Input
            id="onTimeDelivery"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <label htmlFor="positiveComments" className="text-sm font-medium">
            Positive Comments
          </label>
          <Textarea
            id="positiveComments"
        ...
        <div className="space-y-2">
          <label htmlFor="negativeComments" className="text-sm font-medium">
